...
function Login() {
  return (
    <div className="relative flex h-screen w-screen flex-col space-y-6 md:items-center md:justify-center md:bg-transparent">
      <Head>
      ...
      <form className="relative mt-24 space-y-8 rounded py-10 px-6 md:mt-0 md:max-w-md md:px-14">
        <div className="space-y-6 px-6 text-xl">
          <label className="inline-block w-full">
            <p className="text-md my-2">Email Address</p>
            <input
              type="email"
              placeholder="Email"
